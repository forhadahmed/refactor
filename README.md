...
- two larger blocks found to be similar can have their subtree (of smaller blocks) discarded from processing
- default minimum block size filter is used which discards many smaller blocks 
